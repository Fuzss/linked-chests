package fuzs.linkedchests.common.client.renderer.special;
...
import fuzs.linkedchests.common.client.renderer.blockentity.LinkedChestModelSet;
...
public class LinkedChestSpecialRenderer implements SpecialModelRenderer<DyeChannel> {
    ...
    @Override
    public void submit(@Nullable DyeChannel dyeChannel, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, int packedLight, int packedOverlay, boolean hasFoilType, int outlineColor) {
        ...
        this.submitChestModel(poseStack,
                ...
                dyeChannel != null && dyeChannel.uuid().isPresent() ? this.buttonsMaterial : this.chestMaterial,
                -1);
        int[] dyeColors = (dyeChannel != null ? dyeChannel : DyeChannel.DEFAULT).dyeColors();
